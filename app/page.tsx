      ...
      <section id="pricing" className="landing-section" style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, maxWidth: 700, margin: '0 auto' }}>
          ...
          <div style={{ background: 'linear-gradient(145deg, rgba(59,130,246,0.12), rgba(139,92,246,0.08))', border: '1px solid rgba(59,130,246,0.3)', borderRadius: 20, padding: 32, position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <p style={{ fontSize: 42, fontWeight: 800, marginBottom: 4 }}>$10</p>
...
const SESSION_TYPES = [
  ...
  { icon: '💻', title: 'Online Test & Onboarding', bg: 'rgba(251,146,60,0.15)', borderColor: 'rgba(251,146,60,0.2)', color: '#fb923c', desc: 'Get real-time AI assistance during coding challenges, MCQ assessments, and onboarding tests.', cta: 'Online Test & Onboarding' },
]
