...
const FEATURES = [
  ...
  { icon: '📚', title: 'Solved Assessment library', bg: 'rgba(167,139,250,0.15)', desc: 'Browse curated Q&A by platform and assessment type — study offline from the Premium Plus library.' },
  ...
  { icon: '⌨️', title: 'Auto-Typer',                bg: 'rgba(74,222,128,0.12)', desc: 'Paste answers into forms, IDE fields, or essay boxes at a natural human pace — included with Premium Plus.' },
...
const SESSION_TYPES = [
  ...
  { icon: '💻', title: 'Online Assessment & Onboarding', bg: 'rgba(251,146,60,0.15)', borderColor: 'rgba(251,146,60,0.2)', color: '#fb923c', desc: 'Capture screenshots, stack frames, and Analyse All for scored answers. Premium Plus unlocks the Solved Assessment library and Auto-Typer.', cta: 'Online Assessment & Onboarding' },
]
